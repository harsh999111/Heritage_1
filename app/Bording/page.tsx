  ...
  return (
    <div className="bg-yellow-100 h-full w-full mr-0 p-0 pb-8 sm:pb-10 md:pb-14 lg:pb-2 2xl:pb-8 ">
      <div className="main-boarding">
        <p
          className="pt-8 text-center text-2xl text-red-400 lg:text-4xl "
        ...
        <div className="main-2">
          <p
            style={{ fontFamily: "Gabriela" }}
            className="px-2 pl-4 pt-8 text-2xl sm:text-center sm:pt-0 md:text-center md:text-3xl  md:pt-0 lg:text-4xl xl:text-5xl 2xl:pt-0 " 
          >
            Welcome
          </p>
          <p
        ...
        <div className="pt-44 sm:pt-32 md:pt-[70px] lg:pt-6 xl:pt-28 2xl:pt-5">
          <Link href="/Bording1" className=" relative -right-60 sm:-right-[550px] md:-right-[670px] lg:-right-[950px] xl:-right-[1190px] xl:text-2xl 2xl:-right-[1550px] ">Next &gt;&gt;</Link>
        </div>
      </div>
    </div>
  );
