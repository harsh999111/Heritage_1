    ...
    <div className='bg-yellow-100 h-full w-full mr-0 p-0 pb-10 sm:pb-7 md:pb-5 2xl:pb-7'>
      <div className="main-boarding">
        ...
        <div className="main-2">
          <p style={{ fontFamily: 'Gabriela' }} className='px-2  pl-4 pt-8 text-2xl sm:text-center sm:pt-3 md:pt-0 lg:text-4xl lg:pt-3 xl:text-5xl '>About Us</p>
        ...
        <div className="btn pt-[135px] sm:pt-6 md:pt-2 lg:pt-5  lg:px-6 xl:text-2xl xl:pt-9 2xl:pt-4 2xl:px-8">
          <Link href="/Bording" className='relative -right-4 '>&lt;&lt; Previous</Link>
          <Link href="/Bording2" className='-right-40 relative sm:-right-[450px] md:-right-[600px] lg:-right-[800px] xl:-right-[1030px] 2xl:-right-[1400px]'>Next &gt;&gt;</Link>
        </div>
      </div>
    </div>
  );
