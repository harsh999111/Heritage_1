  ...
  return (
    <div className='bg-yellow-100 h-full w-full mr-0 p-0 pb-10 sm:pb-7 md:pb-5 2xl:pb-7'>
      <div className="main-boarding">
        <p className='pt-2 text-center text-2xl text-red-400 sm:pt-6 md:pt-4 lg:text-4xl lg:pt-4  xl:pt-6 ' style={{ fontFamily: 'Gabriela' }}>Taj Mahal </p>
        ...
        <div className="btn pt-[22px] px-0 sm:pt-6 md:pt-2 lg:pt-5  lg:px-6 xl:text-2xl xl:pt-9 2xl:pt-4 2xl:px-8">
          <Link href="/Bording" className='relative -right-4 '>&lt;&lt; Previous</Link>
          <Link href="/Bording2" className='-right-[210px] relative sm:-right-[450px] md:-right-[600px] lg:-right-[800px] xl:-right-[1030px] 2xl:-right-[1400px]'>Next &gt;&gt;</Link>
        </div>
      </div>
    </div>
  );
