  ...
  return (
    <div className='bg-yellow-100 h-full w-full mr-0 p-0 pb-10 sm:pb-7 md:pb-5 2xl:pb-10'>
      <div className="main-boarding">
        <p className='pt-0 text-center text-2xl text-red-400 sm:pt-6 md:pt-4 lg:text-4xl lg:pt-4  xl:pt-6 ' style={{ fontFamily: 'Gabriela' }}>Heritage </p>
        <div className="main-1 pt-6 pb-0 sm:pt-1 sm:pb-0  md:pt-0 md:pb-0 lg:px-16 xl:px-[40px]  xl:pt-5">
        ...
        <div className="btn pt-[28px] sm:pt-6 md:pt-2 lg:pt-5  lg:px-6 xl:text-2xl xl:pt-9 2xl:pt-12 2xl:px-8">
